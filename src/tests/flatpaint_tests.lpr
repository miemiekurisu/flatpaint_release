...
{$endif}
  ...
  fpsurface_tests, fpuihelpers_tests, mainform_integration_tests, fpdocument_tests, tools_move_tests, tool_transaction_tests, tools_select_tests, fpselection_tests, fppalettehelpers_tests,
  fptabhelpers_tests,
