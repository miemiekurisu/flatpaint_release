...
uses
  SysUtils, Controls, StdCtrls, ComCtrls, FPCurvesHelpers;
...
begin
  ...
  LabelCtrl.Left := 150;
  LabelCtrl.Top := 18;
  LabelCtrl.Caption := '0.10 to 5.00';
  ...
  LabelCtrl.Left := 14;
  LabelCtrl.Top := 126;
  LabelCtrl.Caption := 'Current baseline uses one shared RGB gamma curve.';
...
begin
  ...
  try
    ...
    FPreviewLabel.Caption := 'Midtones: ' + FormatGammaText(FGamma) + ' gamma';
  finally
    FUpdating := False;
  end;
end;
