...
我受够了 macOS 上那种“只是临时修个图，还要付费订阅/看广告/开网页”的工具了。
所以自己做了一个：FlatPaint。

它不是那种大而全的软件，目标很直接：
把日常最常用的轻量位图编辑功能，做成一个本地、小而实用的 app。

已经有的功能包括图层、选区、画笔、文字、基础图形、裁剪缩放旋转翻转、导出控制等。
适合拿来处理截图、简单修图、画标注、做轻量编辑。

如果你也正好想找一个免费本地工具，可以试试看。
